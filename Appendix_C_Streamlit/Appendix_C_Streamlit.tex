...
\title{Supplement to ``Identifying Rational Types in Unknown Environments under an Indirect Dynamic Mechanism''\\
...
\url{https://7kkgn4sfscykkfvv5794qw.streamlit.app/}\\
...
\url{https://github.com/Donzhumber/CE.git}\\
