...
% !TEX root = Bernal_H_COMP_ECON.tex
...
\title[Identifying Rational Types under an Indirect Dynamic Mechanism]{Identifying Rational Types in Unknown Environments under an Indirect Dynamic Mechanism}

\author*[1,2]{\fnm{Humberto} \sur{Bernal}}\email{hbernal@uniandes.edu.co}

\affil*[1]{\orgdiv{Economics Program}, \orgname{Universidad Colegio Mayor de Cundinamarca}, \orgaddress{\city{Bogot\'a}, \country{Colombia}}}
\affil[2]{\orgdiv{Ph.D. in Economics}, \orgname{Universidad de los Andes}, \orgaddress{\city{Bogot\'a}, \country{Colombia}}}

\abstract{This paper establishes the Rational Type Identification Theorem as the principal theoretical contribution within a dynamic indirect mechanism design framework for unknown environments characterized by observational pooling. The theorem proves that posterior Bayesian beliefs converge almost surely to the true latent type along prolonged interactions, overcoming short-run observational equivalence without relying on direct revelation reports. This asymptotic identification is enabled by the introduction of the Mano de Dios--Guadalupe (MDG) process, an endogenous implementation noise kernel with maximum-entropy foundations that maps latent strategic intentions into executed actions with full support, thereby preserving non-degenerate off-path Bayesian updating within a competing risks architecture. Complementing this result, the Implementability Theorem guarantees that the indirect dynamic mechanism is executable in a Perfect Bayesian Equilibrium subject to sequential rationality and dynamic incentive compatibility. The empirical application to kidnapping for ransom in Colombia demonstrates the computational tractability of the framework through microeconometric calibration and deep-learning structural simulations, validating the speed of Bayesian type separation and the robustness of policy instruments.}
...
\pacs[JEL Classification]{C73, D82, D86}
...
\subsection*{MDG endogenous implementation kernel}
...
\subsection*{Type Identification Theorem for rational types}
...
\subsection*{Conditional PBE implementability}
...
\end{tabular}
\footnotetext{Source: Author's elaboration.}
\end{table}
...
\subsection*{Funding}
The author received no funding for this research. All work was developed as an independent initiative.
...
The dataset compiled from the Centro Nacional de Memoria Histórica (CNMH) microdata and the empirical calibration inputs are available in the public GitHub repository: \url{https://github.com/Donzhumber/CE.git}.

\subsection*{Code availability}
The complete replication codes (Stata scripts for calibration, Lean 4 interactive proofs, PyTorch training, and Streamlit simulation engine scripts) are available in the public GitHub repository: \url{https://github.com/Donzhumber/CE.git}.

\subsection*{Author contribution}
Humberto Bernal is the sole author of this work and was responsible for the conceptualization, mathematical proofs, Stata calibration, Lean 4 formalization, PyTorch training, Streamlit implementation, and writing of the manuscript.
